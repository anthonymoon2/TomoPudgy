    ...
    <nav className="navbarStyle text-5xl tracking-[.75rem]">
      <div className="max-w-screen-l flex flex-wrap items-center justify-between mx-auto p-2">
        ...
        <button
          ...
          type="button"
          className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="flex flex-col p-4 md:p-0 mt-4 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0">
            ...
            <li>
              <NavLink
                to="/profile"
                className="navbarLink block py-2 px-3 text-gray-900 rounded md:hover:bg-transparent md:border-0 md:p-0 dark:text-white 0 dark:hover:text-white"
              >
                Profile
              </NavLink>
            </li>
            <li>
              <NavLink
                to="/"
                className="navbarLink block py-2 px-3 text-gray-900 rounded md:hover:bg-transparent md:border-0 md:p-0 dark:text-white"
